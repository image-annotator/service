...
| ----------------------- | ------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PORT                    | string        | localhost:8081              | http address (accepts also port number only for heroku compability)                                                                                                                                       |
...
| AUTH_LOGIN_URL          | string        | http://localhost:8081/login | client login url as sent in login token email                                                                                                                                                             |
